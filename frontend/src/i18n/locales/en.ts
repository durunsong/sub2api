export default {
  ...
  admin: {
    ...
    ipBans: {
      ...
      emailRegexHelp: 'Go regex against the full lowercase email. Examples: @365\\.liout\\.com$ blocks liout; \\+[^@]+@hotmail\\.com$ blocks Hotmail plus aliases; \\.[^@]*\\.[^@]+@gmail\\.com$ blocks dotted Gmail locals.',
