export default {
    accounts: {
      ...
      anthropic: {
        ...
        customHeadersDesc: '为上游 API 请求添加自定义请求头，会覆盖同名已有头。不允许设置认证头（Authorization、x-api-key）。',
        customHeadersHint: '自定义头最后应用，覆盖已有值。禁止：Host、Content-Length、Authorization、x-api-key。',
