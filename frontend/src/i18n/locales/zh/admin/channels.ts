export default {
    ...
    channels: {
      ...
      editChannel: '编辑渠道',
      deleteChannel: '删除渠道',
      noGroupsSelected: '请先为 {platform} 选择至少一个分组',
      emptyModelsInPricing: '{platform} 存在未填写模型的定价条目，请补全或删除',
      statusActive: '启用',
      statusDisabled: '停用',
      allStatus: '全部状态',
      groupsUnit: '个分组',
    ...
    subscriptions: {
      ...
      followResetDate: '月额度重置日跟随到期时间',
      followResetDateHint: '下次月额度重置时间将与调整后的到期时间一致；已调整过的订阅可将天数填 0，仅同步重置时间',
      assign: '分配',
      assigning: '分配中...',
      adjust: '调整',
      adjusting: '调整中...',
