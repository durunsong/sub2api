export default {
    ...
    subscriptions: {
      ...
      followResetDate: 'Align monthly reset with expiry',
      followResetDateHint: 'Align the next monthly reset with the adjusted expiry. Enter 0 days to align an existing subscription without changing its expiry.',
      assign: 'Assign',
      assigning: 'Assigning...',
      adjust: 'Adjust',
      adjusting: 'Adjusting...',
