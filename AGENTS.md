...
| 已同步基线 | tag **v0.2.8**（官方无 v0.1.174 tag） |
| 当前 VERSION | `backend/cmd/server/VERSION` = **0.2.8** |
...
`upstream/main` 可能领先于 v0.2.8；同步时以 release tag 为基线，不带入 tag 后的 `main` 内容，并逐文件保留 Fork 模块。
