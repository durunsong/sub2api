...
func (s *AuthService) RegisterWithVerification(ctx context.Context, email, password, verifyCode, promoCode, invitationCode, affiliateCode string) (string, *User, error) {
	...
	if err := s.validateRegistrationEmailPrecheck(ctx, email); err != nil {
		return "", nil, err
	}
...
func (s *AuthService) validateRegistrationEmailPrecheck(ctx context.Context, email string) error {
	...
	return s.validateRegistrationEmailQuota(ctx, email)
}
