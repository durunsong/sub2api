...
func init() {
	...
	groupDescKiroCacheEmulationEnabled := groupFields[52].Descriptor()
	...
	groupDescKiroAutoStickyEnabled := groupFields[53].Descriptor()
	...
	groupDescKiroStickySessionTTLSeconds := groupFields[54].Descriptor()
	...
	groupDescKiroCacheEmulationRatio := groupFields[55].Descriptor()
